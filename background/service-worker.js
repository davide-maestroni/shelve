...
function setActionIcon() {
  ...
  for (const size of sizes) {
    ...
    // Background
    rr(0, 0, 128, 128, 16, '#4f46e5');
    // Side panels
    rr(8, 8, 8, 112, 3, '#a5b4fc');
    rr(112, 8, 8, 112, 3, '#a5b4fc');
    // Books row 1
    rr(20, 10, 16, 32, 2, '#f59e0b');
    rr(40, 14, 12, 28, 2, '#10b981');
    rr(56, 8,  18, 34, 2, '#ef4444');
    rr(78, 12, 14, 30, 2, '#8b5cf6');
    rr(96, 10, 12, 32, 2, '#3b82f6');
    // Shelf board 1
    rr(8, 46, 112, 10, 3, '#c7d2fe');
    // Books row 2
    rr(20, 56, 14, 28, 2, '#06b6d4');
    rr(38, 52, 18, 32, 2, '#f97316');
    rr(60, 58, 12, 26, 2, '#84cc16');
    rr(76, 54, 16, 30, 2, '#ec4899');
    rr(96, 58, 12, 26, 2, '#a5b4fc');
    // Shelf board 2
    rr(8, 86, 112, 10, 3, '#c7d2fe');
    // Bottom shelf
    rr(8, 112, 112, 8, 3, '#c7d2fe');
